...
.banner-area{padding:284px 0 144px ;background-color:#b0b0b0;background-image:url("assets/images/depannage-informatique-slide0.jpg");background-repeat:no-repeat;background-position:center;background-size:cover;position:relative}
    ...
    <!-- Banner Area End -->
      ...
      <div class="box">
        <img src="assets/images/LOGO-2018 bleu.png">
                <h2><strong>Authentification Admin</strong></h2>
               <form method="POST" action="">
                 <div class="inputBox">
                <input  type="texte" name="Login" required=""> <label><i class="fa fa-user" aria-hidden="true"></i>   Login</label></div>
               <div class="inputBox">
                <input  type="password" name="password" required=""><label><i class="fa fa-lock"></i> Mot de passe</label></div>
...
<style type="text/css">
  ...
  <?php
       if (isset($_POST['connexion'])){
        ...
        $query="SELECT Login,Passeword,type FROM personne WHERE  Login='".$_POST['Login']."'and Passeword='".$_POST['password']."' and type='Admin'";
