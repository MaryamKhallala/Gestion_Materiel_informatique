...
<form method="POST" action="">
                    ...
                    <div class="form-group">
                      ...
                      <input class="form-control" placeholder="Recherche par Designation" name="search" required="" type="text"  >
                    </div>
...
$Search=$_POST['search'];
$sql="select * from materiel join composante where type='MicroOrdinateur' and materiel.Serie=composante.Serie and   Designation= '".$_POST['search']."' ";
...
<?php
  ...
  $r2="select * from materiel join composante where type='MicroOrdinateur' and materiel.Serie=composante.Serie ";
  $req2=mysqli_query($con,$r2);
  echo "<table style='width:2000px'><tr class='tbl'><td>Serie</td><td>type materiel</td><td>Username</td><td>reference</td><td>etat</td><td>Designation</td><td>debut_affec</td><td>fin_affec</td><td>Id_composant</td><td>type_C</td><td>Detail</td><td>Date_installer</td><td>Editer</td>
  <div class='card-block'
 <br>
 <br>
                                <h1 style=' text-decoration:underline;color=#73A5F1;'>Liste MicroOrdinateur: </h1>
                                </div>";
